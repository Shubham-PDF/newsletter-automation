...
|---|---|---|---|---|---|---|
| OpenAI News | `rss` | 200 | 1110 | 10 | ✅ Healthy | OK |
| Hugging Face Blog | `rss` | 200 | 834 | 2 | ✅ Healthy | OK |
| AWS What's New | `rss` | 200 | 100 | 53 | ✅ Healthy | OK |
| Google Cloud Release Notes | `rss` | 200 | 30 | 6 | ✅ Healthy | OK |
| Microsoft Azure AI Blog | `rss` | 200 | 10 | 0 | ✅ Healthy | OK |
| Google Research Blog | `rss` | 200 | 100 | 1 | ✅ Healthy | OK |
| OpenRouter Model Diff | `openrouter` | 200 | 340 | 340 | ✅ Healthy | OK |
| Hugging Face Trending Models | `hf_api` | 200 | 30 | 30 | ✅ Healthy | OK |
| GitHub Releases Watchlist | `gh_releases` | 200 | 10 | 2 | ✅ Healthy | OK |
| Simon Willison Weblog | `rss` | 200 | 15 | 3 | ✅ Healthy | OK |
...
| Modern Retail | `rss` | 200 | 10 | 10 | ✅ Healthy | OK |
| Supply Chain Dive | `rss` | 200 | 10 | 10 | ✅ Healthy | OK |
